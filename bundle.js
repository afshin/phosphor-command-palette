...
/***/ function(module, exports, __webpack_require__) {
	...
	|----------------------------------------------------------------------------*/
	'use-strict';
	var phosphor_command_1 = __webpack_require__(1);
	var phosphor_boxpanel_1 = __webpack_require__(3);
	var phosphor_widget_1 = __webpack_require__(17);
	var phosphor_dockpanel_1 = __webpack_require__(28);
	var status_1 = __webpack_require__(43);
	var commandpalette_1 = __webpack_require__(44);
	var registry_1 = __webpack_require__(47);
	var matcher_1 = __webpack_require__(48);
	__webpack_require__(65);
	var INSTRUCTIONS = 'Check out the command palette';
	var registry = registry_1.CommandRegistry.instance();
	...
	var commandItems = [
	    {
	        ...
	        shortcut: '⌘⎋',
	        command: new phosphor_command_1.DelegateCommand(function () { window.alert('Sumer'); })
	    },
	    {
	        id: 'demo:nes:babylon',
	        title: 'Show Babylon',
	        ...
	        shortcut: '⌘⎋',
	        command: new phosphor_command_1.DelegateCommand(function () { window.alert('Babylon'); })
	    },
	    {
	        id: 'demo:nes:oldking',
	        ...
	        shortcut: '⌘⎋',
	        command: new phosphor_command_1.DelegateCommand(function () { window.alert('Old Kingdom'); })
	    },
	    {
	        id: 'demo:nes:tyre',
	        title: 'Show Tyre',
	        ...
	        shortcut: '⌘⎋',
	        command: new phosphor_command_1.DelegateCommand(function () { window.alert('Tyre'); })
	    },
	    {
	        id: 'demo:nes:hittite',
	        ...
	        shortcut: '⌘⎋',
	        command: new phosphor_command_1.DelegateCommand(function () { window.alert('Hittites'); })
	    },
	    {
	        id: 'demo:nes:parthia',
	        title: 'Show Parthia',
	        ...
	        shortcut: '⌘⎋',
	        command: new phosphor_command_1.DelegateCommand(function () { window.alert('Parthia'); })
	    },
	    {
	        id: 'demo:nes:neobab',
	        ...
	        shortcut: '⌘⎋',
	        command: new phosphor_command_1.DelegateCommand(function () { window.alert('Neo Babylonia'); })
	    },
	    {
	        id: 'demo:foobar:foo',
	        title: 'Foo',
	        caption: 'Foo caption',
	        shortcut: '⌘⎋',
	        command: new phosphor_command_1.DelegateCommand(function () { window.alert('Foo'); })
	    },
	    {
	        id: 'demo:foobar:bar',
	        title: 'Bar',
	        caption: 'Bar caption',
	        shortcut: '⌘⎋',
	        command: new phosphor_command_1.DelegateCommand(function () { window.alert('Bar'); })
	    },
	    {
	        id: 'demo:foobar:baz',
	        title: 'Baz',
	        caption: 'Baz caption',
	        shortcut: '⌘⎋',
	        command: new phosphor_command_1.DelegateCommand(function () { window.alert('Baz'); })
	    },
	    {
	        id: 'demo:foobar:qux',
	        title: 'Qux',
	        caption: 'Qux caption',
	        shortcut: '⌘⎋',
	        command: new phosphor_command_1.DelegateCommand(function () { window.alert('Qux'); })
	    }
	];
	function createDock() {
	    var dock = new phosphor_dockpanel_1.DockPanel();
	...
	function createPalette() {
	    ...
	    palette.search.connect(function (sender, args) {
	        var search = args;
	...
	function main() {
	    ...
	    var panel = createPanel(header, palette, dock, status);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var phosphor_signaling_1 = __webpack_require__(2);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var phosphor_boxengine_1 = __webpack_require__(5);
	var phosphor_domutil_1 = __webpack_require__(6);
	var phosphor_messaging_1 = __webpack_require__(12);
	var phosphor_properties_1 = __webpack_require__(16);
	var phosphor_widget_1 = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	|----------------------------------------------------------------------------*/
	'use strict';
	var phosphor_disposable_1 = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	|----------------------------------------------------------------------------*/
	'use strict';
	var phosphor_queue_1 = __webpack_require__(15);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrays = __webpack_require__(4);
	var phosphor_messaging_1 = __webpack_require__(12);
	var phosphor_observablelist_1 = __webpack_require__(20);
	var phosphor_signaling_1 = __webpack_require__(2);
	var messages_1 = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var phosphor_messaging_1 = __webpack_require__(12);
	var phosphor_nodewrapper_1 = __webpack_require__(22);
	var phosphor_properties_1 = __webpack_require__(16);
	var phosphor_signaling_1 = __webpack_require__(2);
	var messages_1 = __webpack_require__(18);
	var panel_1 = __webpack_require__(19);
	var title_1 = __webpack_require__(23);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrays = __webpack_require__(4);
	var phosphor_domutil_1 = __webpack_require__(6);
	var phosphor_dragdrop_1 = __webpack_require__(29);
	var phosphor_nodewrapper_1 = __webpack_require__(22);
	var phosphor_properties_1 = __webpack_require__(16);
	var phosphor_splitpanel_1 = __webpack_require__(30);
	var phosphor_stackedpanel_1 = __webpack_require__(33);
	var phosphor_tabs_1 = __webpack_require__(36);
	var phosphor_widget_1 = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var COMMAND_ID = 'data-command-id';
	var PALETTE_CLASS = 'p-Command-Palette';
	var HEADER_CLASS = 'p-header';
	var COMMAND_CLASS = 'p-command';
	var DESCRIPTION_CLASS = 'p-description';
	var SHORTCUT_CLASS = 'p-shortcut';
	var SEARCH_CLASS = 'p-search';
	var UP_ARROW = 38;
	var DOWN_ARROW = 40;
	;
	;
	var searchID = 0;
	var executeSignal = new phosphor_signaling_1.Signal();
	var searchSignal = new phosphor_signaling_1.Signal();
	var CommandPalette = (function (_super) {
	    ...
	    Object.defineProperty(CommandPalette.prototype, "execute", {
	        get: function () {
	    ...
	    Object.defineProperty(CommandPalette.prototype, "search", {
	        get: function () {
	    ...
	    CommandPalette.prototype._evtKeyDown = function (event) {
	        ...
	        var input = this._search.querySelector('input');
	        if (keyCode !== UP_ARROW && keyCode !== DOWN_ARROW) {
	            var oldValue = input.value;
	            requestAnimationFrame(function () {
	                var newValue = input.value;
	                if (newValue !== oldValue) {
	                    _this.search.emit({ query: newValue, id: ++searchID });
	                }
	            });
	            return;
	        }
	    ...
	    CommandPalette.prototype._emptyList = function () {
	        var list = this._list;
	        while (list.firstChild) {
	            list.removeChild(list.firstChild);
	        }
	    };
	    CommandPalette.prototype._renderCommandItem = function (item) {
	    ...
	    CommandPalette.prototype._renderHeading = function (heading) {
	        var header = document.createElement('div');
	    ...
	    CommandPalette.prototype._renderList = function () {
	        this._list = document.createElement('div');
	        this.node.appendChild(this._list);
	    };
	    CommandPalette.prototype._renderSearch = function () {
	    ...
	    CommandPalette.prototype._renderSection = function (section) {
	        ...
	        section.commands.forEach(function (item) { _this._renderCommandItem(item); });
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./commandpalette.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./commandpalette.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*-----------------------------------------------------------------------------\n| Copyright (c) 2014-2015, PhosphorJS Contributors\n|\n| Distributed under the terms of the BSD 3-Clause License.\n|\n| The full license is in the file LICENSE, distributed with this software.\n|----------------------------------------------------------------------------*/\n.p-Command-Palette {\n  background: #f5f5f5;\n  min-width: 150px;\n  max-width: 250px;\n  min-height: 50px;\n  padding: 5px 3px;\n  overflow: auto;\n}\n\n.p-Command-Palette .p-header {\n  color: #757575;\n  font-size: 11px;\n  font-weight: 500;\n  padding: 5px;\n}\n\n.p-Command-Palette .p-header hr {\n  border-width: 0;\n  margin: 3px -3px;\n  padding: 0;\n  color: #e0e0e0;\n  background-color: #e0e0e0;\n  height: 1px;\n  width: 100%;\n}\n\n.p-Command-Palette .p-search input {\n  border: 1px solid #e0e0e0;\n  border-radius: 5px;\n  padding: 4px 0;\n  width: calc(100% - 8px);\n}\n\n.p-Command-Palette .p-command {\n    font-weight: 500;\n    margin: 0 -3px;\n    padding: 3px;\n}\n\n.p-Command-Palette .p-command .p-description {\n    color: #9e9e9e;\n    font-weight: 400;\n    font-size: 10px;\n}\n\n.p-Command-Palette .p-command .p-shortcut {\n    float: right;\n    margin-right: 15px;\n}\n\n.p-Command-Palette .p-command:hover,\n.p-Command-Palette .p-command:hover .p-description,\n.p-Command-Palette .p-command:hover .p-shortcut {\n  background: #2196f3;\n  color: #fff;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommandRegistry = (function () {
	     ...
	     */
	    CommandRegistry.instance = function () {
	     ...
	     */
	    CommandRegistry.commandsAddedSignal = new phosphor_signaling_1.Signal();
	    /**
	     * A signal emitted when commands are removed from the registry.
	     *
	     * **See also:** [[commandsAdded]]
	     */
	    CommandRegistry.commandsRemovedSignal = new phosphor_signaling_1.Signal();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FuzzySearch = __webpack_require__(49);
	var IndexOfFS = __webpack_require__(61);
	var WordCountFS = __webpack_require__(63);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var prime = __webpack_require__(50);
	...
	var obj = {
		...
		'fromPath': __webpack_require__(60),
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/"use strict"
	...
	var forOwn = __webpack_require__(54)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var prime = __webpack_require__(50);
	var FSModule = __webpack_require__(62);
	var arr = {
		'forEach': __webpack_require__(59)
	};
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
